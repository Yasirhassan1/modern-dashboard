...
export default function SoftUISection(){
    return(
        <section className="flex gap-3 justify-between flex-wrap">
            <div className="softCard flex justify-between gap-3 p-3 border border-gray-300 rounded-lg flex-wrap bg-tertiary">
            ...
            <img src={bgPic} className="object-cover h-full rounded-lg opacity-80 bg-blend-multiply" alt="" />
                 <div class="absolute inset-0 bg-black opacity-50 p-3 rounded-lg"></div>
