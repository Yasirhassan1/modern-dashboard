                ...
                <div className="card-body">
                  <form action={handleForm} role="form" data-gtm-form-interact-id="0">
                    ...
                    <div className="form-check form-switch flex gap-2">
                      <input className="form-check-input" type="checkbox" id="rememberMe" checked={false} data-gtm-form-interact-field-id="0"/>
                      <label className="form-check-label text-text-secondary" >{t('login.remember_me')}</label>
                    </div>
